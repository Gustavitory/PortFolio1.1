export const ES={
    ...
    home:{
        ...
        monolog:'¡Saludos! Te doy la bienvenida a mi portafolio profesional, en el encontraras información sobre proyectos que he realizado, tecnologías que he aprendido a utilizar y porsupuesto una pequeña introduccion sobre mi para que me conozcas un poco. de igual manera te invito a descargar mi CV pulsando el boton que se encuentra debajo.',
    ...
    tech:{
        ...
        reactNative:'React Native, es un framework de código abierto creado por Meta Platforms, Inc.​ Se utiliza para desarrollar aplicaciones para Android, ​ Android TV, ​ iOS, macOS, ​ tvOS, Web, ​ Windows​ y UWP​ al permitir que los desarrolladores usen React con las características nativas de estas plataformas.​',
        graphql:'GraphQL es un lenguaje de consulta y manipulación de datos para APIs, y un entorno de ejecución para realizar consultas con datos existentes.​ GraphQL fue desarrollado internamente por Facebook en 2012 antes de ser liberado públicamente en 2015.​',
        ...
        express:'Express.js o simplemente Express, es un entorno de trabajo para aplicaciones web para el programario Node.js, de código abierto y con licencia MIT. Se utiliza para desarrollar aplicaciones web y APIs. El autor original es TJ Holowaychuk y la primera versión se lanzó el 2010.',
